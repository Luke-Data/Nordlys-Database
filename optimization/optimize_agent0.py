...
# 1. LM CONFIGURATION
# ---------------------------------------------------------------------------
# Model name follows litellm convention: "gemini/<model-id>"
# Switch to "gemini/gemini-2.5-flash" or "gemini/gemini-2.0-pro" as needed.
...
def main() -> None:
    ...
    teleprompter = MIPROv2(
        ...
        num_candidates=2,  # Ne genera solo 2 invece di 5 o più
        num_threads=1
    )
